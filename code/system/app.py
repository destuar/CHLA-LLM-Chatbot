...
For the cdc paragraph, attach the link found at the very end of the cdc_context (After Source URL:). The link should be pulled 
directly from the cdc_context variable.
