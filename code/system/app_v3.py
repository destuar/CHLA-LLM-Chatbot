...
If the CHLA or CDC context provided above does not directly answer the user query/question, tell the user that "I am unable to locate the relevant policy documentation relevant to your question. Please consult with CHLA's IPC." and end your response. \n
